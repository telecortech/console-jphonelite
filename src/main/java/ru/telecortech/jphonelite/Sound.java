...
public class Sound {
  ...
  /** Init sound system.  ru.Sound needs access to the lines and the MeterController to send audio levels back to the panel. */

  public boolean init(PhoneLine lines[]) {
    this.lines = lines;
